  ...
  return (
    <footer className='w-full pb-10 mb-[100px] md:mb-5' id='contact'>
       ...
       <div className='flex mt-16 md:flex-row flex-col justify-between items-center'>
        ...
        Built With NextJS,Aceternity UI, Framer Motion and TailwindCSS
        </p>
        <div className='flex items-center md:gap-3 gap-6 pt-3' >
        {socialMedia.map((profile) => (
          <a href={profile.link} target='_blank'><div key={profile.id} className='w-10 h-10 cursor-pointer flex justify-center items-center
